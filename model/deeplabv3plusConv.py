...
class deeplabv3plusConv(nn.Module):
    def __init__(self, cfg):
        super(deeplabv3plusConv, self).__init__()
        self.backbone = None
    ...
    def forward(self, x, y_true=None, y=None, margin=None, feature_cat=None, phase='orig'):
        ...
        # training
            ...
            refine_feature_cat_2 = feature_cat_1 - feature_cat_1 * coe
            ############ refine path2 result ###############
            ...
            return feature_cat_1, result_1, refine_feature_cat_2, refine_result_2, avg_att, self.beta2, coe